...
describe('Service Tests', () => {
  describe('Aliment Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(AlimentService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Aliment(0, 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Aliment', () => {
        ...
        service.create(new Aliment()).subscribe(resp => (expectedResult = resp.body));
