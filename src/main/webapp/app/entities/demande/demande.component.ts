...
export class DemandeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.demandeService
      ...
      .subscribe(
        (res: HttpResponse<IDemande[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDemandes(): void {
    this.eventSubscriber = this.eventManager.subscribe('demandeListModification', () => this.loadPage());
  }
